...
## "set" method.It further saves the value of the inverse into a variable/cache using "setinverse" and "getinverse" is used  
## to retrieve the value of inverse from the cache
...
## In "cacheSolve" we are first checking if the inverse of the matrix created by "makeCacheMatrix" already exists in cahce
## and if it does,the value is pulled from cache for output. Otherwise, it computes the inverse and returns the inversed 
## matrix
...
cacheSolve <- function(x, ...) {
  ...
  inv<-solve(matrix, ...)
  x$setinverse(inv)
## returning the inversed matrix of x in "inv"  
  inv
